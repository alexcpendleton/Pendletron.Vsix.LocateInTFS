...
using Microsoft.LocateInSourceControl;

namespace LocateInSourceControl_UnitTests.MenuItemTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		{
			// Create the package
			IVsPackage package = new LocateInSourceControlPackage() as IVsPackage;
			...
			CommandID menuCommandID = new CommandID(Microsoft.LocateInSourceControl.GuidList.guidLocateInSourceControlCmdSet, (int)Microsoft.LocateInSourceControl.PkgCmdIDList.cmdidLocateInSourceControl);
